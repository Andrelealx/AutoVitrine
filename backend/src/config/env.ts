...
const envSchema = z.object({
  ...
  SUBSCRIPTION_GRACE_DAYS: z.coerce.number().int().positive().default(3),
  SUBSCRIPTION_DATA_RETENTION_DAYS: z.coerce.number().int().positive().default(30),
  SUBSCRIPTION_DUE_REMINDER_DAYS: z.coerce.number().int().positive().default(7),
  TRIAL_WARNING_DAYS: z.coerce.number().int().positive().default(3),
  SUBSCRIPTION_LIFECYCLE_INTERVAL_MINUTES: z.coerce.number().int().positive().default(60),
